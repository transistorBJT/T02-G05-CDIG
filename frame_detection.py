...
class frame_detection(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "frame_detection")
        ...
        self._window_size_range = qtgui.Range(10, 100, 1, 48, 200)
        self._window_size_win = qtgui.RangeWidget(self._window_size_range, self.set_window_size, "'window_size'", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._window_size_win)
        ...
        self.qtgui_time_sink_x_0.set_trigger_mode(qtgui.TRIG_MODE_AUTO, qtgui.TRIG_SLOPE_POS, 0.93, 0.000005, 0, "")
        ...
        self.ieee802_11_frame_equalizer_0 = ieee802_11.frame_equalizer(0, 5.89e9, 10e6, False, False)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(0.1*variable_qtgui_range_0)
    ...
    def set_variable_qtgui_range_0(self, variable_qtgui_range_0):
        ...
        self.blocks_multiply_const_vxx_0.set_k(0.1*self.variable_qtgui_range_0)
...
def main(top_block_cls=frame_detection, options=None):
